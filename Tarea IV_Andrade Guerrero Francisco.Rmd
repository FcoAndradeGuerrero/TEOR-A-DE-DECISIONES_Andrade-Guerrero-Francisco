...
En este caso, f2 considera que el impacto del tiempo de viaje es uniforme para todas las opciones. Es decir, un aumento en el tiempo de viaje reduce la utilidad de cada alternativa en igual medida.
...
Model3 permite que el impacto del tiempo de viaje varíe según la alternativa. Es decir, cada modo de transporte puede experimentar una influencia diferente ante un incremento en el tiempo de viaje.
...
Conforme aumenta el tiempo de viaje, disminuye la probabilidad de optar por el automóvil, el autobús o ir a pie. En cambio, la probabilidad de escoger la bicicleta se incrementa.
...
El modelo 2 (model3) presenta un ajuste considerablemente superior al del modelo 1 (model2). Esto indica que permitir que el impacto del tiempo de viaje varíe según el medio de transporte mejora notablemente el modelo.

Para obtener el modelo 2, sería necesario aplicar una restricción que iguale los coeficientes del tiempo de viaje para todas las alternativas.
